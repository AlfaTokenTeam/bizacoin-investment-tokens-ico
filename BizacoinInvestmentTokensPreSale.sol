...
import "./BizacoinInvestmentTokens.sol";

contract BizacoinInvestmentTokensPreSale {
    BizacoinInvestmentTokens public token;
    ...
    function BizacoinInvestmentTokensPreSale(
        BizacoinInvestmentTokens _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = BizacoinInvestmentTokens(_token);
